...
import com.desuzed.brewerytestapp.ui.brewery_fragments.BreweryListViewModel
...
class ViewModelFactory(private val repositoryApp: RepoApp) : ViewModelProvider.Factory {
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        return when {
            modelClass.isAssignableFrom(BreweryListViewModel::class.java) -> {
                BreweryListViewModel(repositoryApp) as T
            }
